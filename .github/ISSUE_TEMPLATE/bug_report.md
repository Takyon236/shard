...
This template describes v4. `v4.0.7` is published and installs anonymously — no account, no granted
...
- Shard source commit and exact Action ref (`v4.0.7`, or the commit you pinned):
